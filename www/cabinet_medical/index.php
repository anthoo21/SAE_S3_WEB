...
if (isset($_POST['login']) && isset($_POST['password'])) {
	...
	if($stmt->rowCount() == 1) {
		...
		if($_SESSION['role'] == 'MED') {
			$requeteMedecin  = "SELECT medecins.nom, medecins.prenom, utilisateurs.code_role FROM utilisateurs JOIN medecins ON identifiant = id_util WHERE identifiant = :log AND motDePasse = :mdp";
